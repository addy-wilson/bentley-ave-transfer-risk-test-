...
| Feature | Description | Transfer Signal |
|---|---|---|
...
By default the script collects seasons `2022`, `2023`, and `2024`. Edit the `SEASONS` list at the top of the script to change this. The API is rate-limited to 5 requests/sec — the script stays conservative at ~4.5 req/sec.

## Labeling

The NCAA API does not include transfer portal data. To train a supervised model, transfer labels must be matched from an external source such as [On3](https://www.on3.com/transfer-portal/) or [247Sports](https://247sports.com/transferportal/) using player name and school.
